...
--
-- Name: gap_recommend; Type: TABLE; Schema: public; Owner: postgre_dev
--

CREATE TABLE public.gap_recommend (
...
ALTER TABLE public.gap_recommend OWNER TO postgre_dev;
...
--
-- Name: general_stat; Type: TABLE; Schema: public; Owner: postgre_dev
--

CREATE TABLE public.general_stat (
    id integer NOT NULL,
...
ALTER TABLE public.general_stat OWNER TO postgre_dev;

--
-- Name: general_stat_id_seq; Type: SEQUENCE; Schema: public; Owner: postgre_dev
--

CREATE SEQUENCE public.general_stat_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.general_stat_id_seq OWNER TO postgre_dev;

--
-- Name: general_stat_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgre_dev
--

ALTER SEQUENCE public.general_stat_id_seq OWNED BY public.general_stat.id;
...
--
-- Name: id; Type: DEFAULT; Schema: public; Owner: postgre_dev
--

ALTER TABLE ONLY public.general_stat ALTER COLUMN id SET DEFAULT nextval('public.general_stat_id_seq'::regclass);
...
--
-- Name: gap_recommend_pkey; Type: CONSTRAINT; Schema: public; Owner: postgre_dev
--

ALTER TABLE ONLY public.gap_recommend
    ADD CONSTRAINT gap_recommend_pkey PRIMARY KEY (id);
...
--
-- Name: general_stat_pkey; Type: CONSTRAINT; Schema: public; Owner: postgre_dev
--

ALTER TABLE ONLY public.general_stat
    ADD CONSTRAINT general_stat_pkey PRIMARY KEY (id);
